...
const NoCredits: React.FC<NoCreditsProps> = () => {
  return (
    <Card className="relative border border-red-200 dark:border-red-900/30 bg-gradient-to-br from-slate-50 to-red-50/50 dark:from-slate-900/80 dark:to-red-950/10 shadow-sm overflow-hidden">
      ...
      <CardContent>
        <P className="text-slate-600 dark:text-slate-400 text-sm text-left">
          Additional <span className="font-medium">credits</span> are needed for this feature. If you find the app
