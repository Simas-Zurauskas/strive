...
interface ComposedAlertDialogProps {
  ...
  onAction?: () => void;
  /**
   * Additional props to pass to the AlertDialog root
   */
  dialogProps?: React.ComponentProps<typeof AlertDialogPrimitive.Root>;
  /**
   * Additional props to pass to the AlertDialogContent
   */
